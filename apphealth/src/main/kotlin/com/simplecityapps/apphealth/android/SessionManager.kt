...
internal class SessionManager(context: Context) {
    ...
    private val _installationId: String

    val sessionId: String
        get() = _sessionId.get()

    /**
     * Persistent installation ID. Generated on first launch, never changes.
     * Use this to correlate telemetry from the same device across sessions.
     */
